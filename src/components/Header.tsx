...
export default function Header() {
  ...
  return (    <nav className="border-b border-slate-800/50 backdrop-blur-sm sticky top-0 z-50 bg-slate-950/80">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex justify-between items-center h-16 rtl:flex-row-reverse">
          {/* Logo */}
          <Link href={`/${locale}`} className="flex items-center gap-3 rtl:flex-row-reverse">
